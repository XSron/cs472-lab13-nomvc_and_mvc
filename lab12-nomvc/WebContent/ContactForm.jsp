...
<body>
	...
	<header>
	 	<nav class="navbar navbar-expand-lg navbar-light bg-light">
			<a class="navbar-brand" href="../lab12-nomvc">CS472-WAP ::: Lab12</a>
			 ...
			 <form action="process-contact-form" method="POST">
				 ...
				 <div class="row">
					 <div class="col-md-12">
						 ...
						 <textarea class="form-control" row="10" name="message"> <%= request.getAttribute("message") == null? "": request.getAttribute("message") %> </textarea>
					 </div>
				 </div>
				 <div class="row">
					 <div class="col-md-12">
